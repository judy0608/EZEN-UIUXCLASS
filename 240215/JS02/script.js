...
// 배열.forEach(function(배열안에 각각의 아이템) {
//   실행문
// })
...
// 해당 숫자가 소수인지 아닌지 식별한 후, 만약 해당 숫자가 소수라면 "00숫자는 소수입니다" 라고 출력해 주세요.
// 소수 : 1과 자기 자신으로만 나눠질 수 있는 숫자
// 단락회로평가 : 특정 값이 논리형 값 => true / false
...
//미션
// 웹브라우저 화면에 아래 보이는 배열 아이템 중 10 이상이 되는 숫자만 출력g하세요.
